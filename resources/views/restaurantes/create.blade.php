...
<input type="text" name="whatsappNum"  pattern="^\+[0-9]{11}$" maxlength="12" id="telf"  style="font-family: Arial;text-align: justify; font-size: 11pt" class="form-control"  aria-describedby="basic-addon1" placeholder="ejemplo: +50370205060" value="{{ old('whatsappNum') }}">
	</div>
	</div>
