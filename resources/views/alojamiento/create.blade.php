...
--> 
	...
	<input type="tel" name="numWhatsapp"  pattern="^\+[0-9]{11}$" maxlength="12" style="font-family: Arial;text-align: justify; font-size: 11pt" class="form-control"  aria-describedby="basic-addon1" placeholder="ejemplo: +50370205060" value="{{ old('numWhatsapp') }}">
	</div>
	</div>
	</div> 
