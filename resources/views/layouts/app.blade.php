    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
              ...
              <i style="color:#03545A;" class="fa fa-home fa-2x" aria-hidden="true"></i>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                    <!-- -----------COMENTAR ESTA PARTE DE CÓDIGO DESPUES DE CREAR USUARIO -->
                                  <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}"><h5>LOGIN</h5></a>
                            </li> <br> 
                          @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"><h5>REGISTRARSE</h5></a>
                                </li>
                            @endif 
                      <!-- -------------------------------------------------------------- -->      
                        @else
