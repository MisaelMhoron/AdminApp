...
font-size: 11pt" for="nombre">Descripción del mapa</label><span style="color:red; font-size: 15pt">*</span>   
	<textarea name="descripcion" rows="3" cols="10" style="font-family: Arial; font-size: 11pt;text-align: justify" id="descripcion" required="required" class="form-control input-sm" placeholder="Descripción del sitio..." value="{{ old('descripcion')}}">{{old('descripcion')}}</textarea>
	</div>
	</div>
	</div>
<!------------------------------------------------------------------------------>	
...
<input type="number"  step="any" max="0"  name="longitude" required="required" id="longitude"  style="font-family: Arial; font-size: 11pt;text-align: justify" class="form-control" aria-describedby="basic-addon1" placeholder="Ejmpl: -89.7212532" value="{{ old('longitude') }}" >
									</div>
