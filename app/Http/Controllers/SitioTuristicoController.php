...
/************************************** */
$thumbnailpath = public_path('/images/uploads/sitiosturistico/'.$name);
...
/************************************** */
$thumbnailpath2 = public_path('/images/uploads/sitiosturistico/'.$name2);
$img2 = Image::make($thumbnailpath2)->resize(960, 640)->save($thumbnailpath2);
/********************************** */
...
/************************************** */
$thumbnailpath3 = public_path('/images/uploads/sitiosturistico/'.$name3);
$img3 = Image::make($thumbnailpath3)->resize(960, 640)->save($thumbnailpath3);
/********************************** */
...
/************************************** */
$thumbnailpath4 = public_path('/images/uploads/sitiosturistico/'.$name4);
$img4 = Image::make($thumbnailpath4)->resize(960, 640)->save($thumbnailpath4);
/********************************** */
}
else{
